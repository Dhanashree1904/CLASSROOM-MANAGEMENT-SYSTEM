...
private void populateTable() {
    ...
    try {
        ...
        String query = "SELECT aid, name, subject_id, profid, file_path FROM assignment";
    ...
    try {
        Statement stmt = connection.getStatement();
        String query = "INSERT INTO assignment (aid,name, subject_id, profid, file_path) VALUES ('" + id + "','" + topic + "', '" + subid + "', '" + pid + "', '" + filePath + "')";
    ...
    int id = (int) ass.getValueAt(selectedRow, 0);

    // Perform the deletion
    MySQLConnection connection = new MySQLConnection();
    try {
        Statement stmt = connection.getStatement();
        String query = "DELETE FROM ASSIGNMENT WHERE Aid = " + id;
        int rowsAffected = stmt.executeUpdate(query);
