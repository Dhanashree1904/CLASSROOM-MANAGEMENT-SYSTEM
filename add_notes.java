...
private void populateTable() {
    ...
    DefaultTableModel model = (DefaultTableModel) notes.getModel();
    model.setRowCount(0); // Clear existing data
    
    try {
        Statement stmt = connection.getStatement();
        String query = "SELECT nid, name, subid, pid, file_path FROM notes";
    ...
    String subid = jTextField3.getText();
    ...
    try {
        Statement stmt = connection.getStatement();
        String query = "INSERT INTO NOTES (Nid,name, subid, pid, file_path) VALUES ('" + id + "','" + topic + "', '" + subid + "', '" + pid + "', '" + filePath + "')";
    ...
    int selectedRow = notes.getSelectedRow();
    ...
    int id = (int) notes.getValueAt(selectedRow, 0);

    // Perform the deletion
    MySQLConnection connection = new MySQLConnection();
    try {
        Statement stmt = connection.getStatement();
        String query = "DELETE FROM notes WHERE nid = " + id;
        int rowsAffected = stmt.executeUpdate(query);
