...
private MySQLConnection connection;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            String query = "SELECT * FROM professor WHERE P_ID = '"+id+"'";
            ...
            if (resultSet.next()) {
                ...
                jTextField4.setText(resultSet.getString("subject"));
                ...
                jTextField8.setText(resultSet.getString("qualifications"));
                jTextField8.setText(resultSet.getString("salary"));
            } else {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            ...
            String updateQuery = "UPDATE professor SET ppass = '" + newPassword + "' WHERE P_ID = '" + id + "'";
